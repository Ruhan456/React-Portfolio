        ...
        <section id="home" className="home-section">
            <div className="home-content">
                ...
                <p className={`home-description ${darkMode ? "dark-text" : "light-text"}`} >
                    Hi, I'm Ruhan. This is my portfolio, where I have displayed my technical projects and skills, as well as many ways to contact me. <br /> <br /> I am currently a Mechatronics Engineer at the University of Waterloo, with great interest in learning more about machine learning and embedded systems
                </p>
            </div>
        </section>
    );
